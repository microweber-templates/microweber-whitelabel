...
<ul class="socials-2">
    ...
    <?php if ($soundcloud_enabled) { ?>
        <li>
            <a href="//soundcloud.com/<?php print $soundcloud_url; ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="SoundCloud"><i class="fa fa-soundcloud"></i></a>
        </li>
    <?php } ?>

    <?php if ($mixcloud_enabled) { ?>
        <li>
            <a href="//mixcloud.com/<?php print $mixcloud_url; ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="MixCloud"><i class="fa fa-mixcloud"></i></a>
        </li>
    <?php } ?>
